...
public class LeaderGradeFragment extends Fragment {
    ...
    public LeaderGradeFragment() {
    }

    @SuppressLint("ValidFragment")
    public LeaderGradeFragment(int weekCode, List<Score> mGradeScoreList) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_leader_grade,container,false);
