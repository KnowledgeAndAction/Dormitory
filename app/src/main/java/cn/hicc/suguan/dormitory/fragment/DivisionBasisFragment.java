...
public class DivisionBasisFragment extends Fragment {
    ...
    public DivisionBasisFragment() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_division_basis,container,false);
