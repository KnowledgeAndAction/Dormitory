...
public class DivisionGradeFragment extends Fragment {
    ...
    public DivisionGradeFragment() {
    }

    @SuppressLint("ValidFragment")
    public DivisionGradeFragment(double avg, int weekCode, List<Score> mGradeScoreList) {
        this.avg = avg;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_division_grade,container,false);
