...
public class LeaderAcademyFragment extends Fragment {

    private BarChart mChart;
    private List<Score> mAcademyScoreList;
    private List<String> xAxisValues;
    private List<Float> yAxisValues;

    public LeaderAcademyFragment() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_leader_academy,container,false);
    ...
    // 设置数据
    public void setData(int weekCode, List<Score> mAcademyScoreList, String dataType) {
        this.mAcademyScoreList = mAcademyScoreList;
    ...
    private void initData(String name) {
        ...
        for (Score score : mAcademyScoreList) {
